...
public class RegManDisc extends JFrame
{
	public RegManDisc()
	{		
		...
		JLabel lbl_tit = new JLabel("MANTENIMIENTO DISCOS");
		...
		btn_aceptar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (!new Funcionalidades().validadorAcep(txt_nom_man, txt_pre_man, txt_tel_man, txt_dia_ent, txt_mes_ent, txt_anio_ent, txt_anio_sal, txt_mes_sal, txt_dia_sal))
				{
					...
					String[] reg_dcom = {"0", "1", ent_man, sal_man, txt_pre_man.getText(), txt_nom_man.getText(), txt_tel_man.getText()};
