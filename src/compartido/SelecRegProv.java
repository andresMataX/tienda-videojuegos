...
public class SelecRegProv extends JFrame
{		
	static int prov_selec;
	...
	{		
		...
		JLabel lbl_tit = new JLabel("SELECCIONAR - PROVEEDORES");
		lbl_tit.setFont(new Font("Roboto", Font.PLAIN, 38));
		lbl_tit.setBounds(116, 75, 540, 45);
		...
		tb_prov.addMouseListener(new MouseAdapter() 
		{
			...
			{
				Funcionalidades selec = new Funcionalidades();
				prov_selec = selec.selecTabla(model, 0, tb_prov, e);
				new RegComProv().setVisible(true);
				dispose();
			}
		});
