...
public class RegManAcc extends JFrame
{
	public RegManAcc()
	{
		...
		JLabel lbl_tit = new JLabel("MANTENIMIENTO ACCESORIOS");
		lbl_tit.setFont(new Font("Roboto", Font.PLAIN, 38));
		lbl_tit.setBounds(22, 75, 550, 45);
		...
		btn_aceptar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (!new Funcionalidades().validadorAcep(txt_nom_man, txt_pre_man, txt_tel_man, txt_dia_ent, txt_mes_ent, txt_anio_ent, txt_anio_sal, txt_mes_sal, txt_dia_sal))
				{
					...
					String[] reg_dcom = {"0", "3", ent_man, sal_man, txt_pre_man.getText(), txt_nom_man.getText(), txt_tel_man.getText()};
