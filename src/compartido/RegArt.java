...
public class RegArt extends JFrame
{
	...
	public RegArt()
	{
		...
		JLabel lbl_titulo = new JLabel("REGISTRAR ART\u00CDCULO");
		lbl_titulo.setFont(new Font("Roboto", Font.PLAIN, 38));
		lbl_titulo.setBounds(189, 75, 386, 45);
		...
		btn_aceptar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				/*String nom_art, pre_art, pro_art, cat_art, cnd_art, cnt_art;
				
				nom_art = txt_nom_art.getText();
				pre_art = txt_pre_art.getText();
				cnt_art = txt_cnt_art.getText();
				
				String[] momo = {nom_art, pre_art, cnt_art};*/
				...
				if (!new Funcionalidades().validadorAcep(txt_nom_art, txt_cnt_art, txt_pre_art, index_cat.getId(), index_cnd.getId(), index_prov.getId()))
				{
					try
					{
						...
						pst.setInt(1, 0);
						pst.setString(2, txt_nom_art.getText());
						pst.setDouble(3, Double.parseDouble(txt_pre_art.getText()));
						pst.setInt(4, index_prov.getId());
						pst.setInt(5, index_cat.getId());
						pst.setInt(6, index_cnd.getId());
						pst.setInt(7, Integer.parseInt(txt_cnt_art.getText()));
					...
					catch (Exception e2)
					{
						...
						JOptionPane.showMessageDialog(null, "¡ERROR EN OPERACIÓN REGISTRAR! Contactar con el Supervisor.");
					}
				}
			}
		});
		...
		btn_regresar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				switch (new Funcionalidades().validadorReg(txt_nom_art, txt_cnt_art, txt_pre_art, cbox_prov_art, cbox_cat_art, cbox_cnd_art))
				{
				case 0:
					dispose();
					break;
