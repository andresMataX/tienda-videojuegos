...
public class SelecModRenCajero extends JFrame
{
	static int cve_ren;
	
	public SelecModRenCajero()
	{
		...
		tb_ren.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				new ModRenCajero().setVisible(true);
				dispose();
			}
		});
		...
		{	
			...
			PreparedStatement pst = cn.prepareStatement(
				"select cve_ren, sal_ren, ret_ren, art_ren from rentas");
