...
public class SelecModProvAdmin extends JFrame
{
	static int cve_prov;
	
	public SelecModProvAdmin()
	{
		...
		JLabel lbl_tit = new JLabel("MODIFICAR - PROVEEDORES");
		lbl_tit.setFont(new Font("Roboto", Font.PLAIN, 38));
		lbl_tit.setBounds(141, 75, 490, 45);
		...
		tb_prov.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				cve_prov = new Funcionalidades().selecTabla(model, 0, tb_prov, e);
				new ModProvAdmin().setVisible(true);
				dispose();
			}
		});
