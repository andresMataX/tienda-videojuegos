...
public class MenRegrAdmin extends JPanel
{
	public MenRegrAdmin()
	{
		...
		btn_cam.setBounds(110, 300, 100, 100);
		Icon icono_cam = deco.icono("caja-de-devolucion.png", 100, 100);
		btn_cam.setIcon(icono_cam);
		add(btn_cam);
		...
		btn_cor.setBounds(558, 300, 100, 100);
		Icon icono_cor = deco.icono("caja-registradora.png", 100, 100);
		btn_cor.setIcon(icono_cor);
		add(btn_cor);
		
		JLabel lbl_cam = new JLabel("CAMBIOS");
		lbl_cam.setForeground(Color.BLACK);
		lbl_cam.setFont(new Font("Roboto", Font.PLAIN, 28));
		lbl_cam.setBounds(99, 400, 130, 33);
		add(lbl_cam);
		
		JLabel lbl_cor = new JLabel("CORTE");
		lbl_cor.setForeground(Color.BLACK);
		lbl_cor.setFont(new Font("Roboto", Font.PLAIN, 28));
		lbl_cor.setBounds(564, 400, 90, 33);
		add(lbl_cor);
