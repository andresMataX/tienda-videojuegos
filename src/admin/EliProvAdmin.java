	...
	public EliProvAdmin()
	{
		...
		tb_prov.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				int seleccion = JOptionPane.showConfirmDialog(null, "¿Estás seguro de eliminar " + cve_prov + "?", "Confirmar Eliminar Artículo", JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.WARNING_MESSAGE);
				if (seleccion == 0)
				{
